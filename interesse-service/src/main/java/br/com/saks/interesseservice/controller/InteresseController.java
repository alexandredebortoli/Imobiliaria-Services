...
public class InteresseController {
    ...
    public Optional<Interesse> listarPeloId(@PathVariable Long idImovel) {
        return interesseRepository.findByInteresseIdentityIdImovel(idImovel);
    }
    
    @GetMapping(value = "/{idImovel}/{idCliente}")
    public Optional<Interesse> findByEmprestimoLivro(@PathVariable Long idImovel, @PathVariable Long idCliente) {
    ...
    public List<Interesse> listarPeloIdImovel(@PathVariable Long idImovel) {
        List<Interesse> interesses = interesseRepository.findAllByInteresseIdentityIdImovel(idImovel);
    ...
    public List<Interesse> listarPeloIdCliente(@PathVariable Long idCliente) {
        List<Interesse> interesses = interesseRepository.findAllByInteresseIdentityIdCliente(idCliente);
        for(Interesse interesse : interesses) {
